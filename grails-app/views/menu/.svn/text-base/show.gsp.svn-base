            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="menu.libelle.label" default="Libelle" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: menuInstance, field: "libelle")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="menu.prix.label" default="Prix" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: menuInstance, field: "prix")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="menu.plats.label" default="Plats" /></td>
                            
                            <td valign="top" style="text-align: left;" class="value">
                                <ul>
                                <g:each in="${menuInstance.plats}" var="p">
