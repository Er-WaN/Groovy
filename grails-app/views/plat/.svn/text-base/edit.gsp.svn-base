                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="menus"><g:message code="plat.menus.label" default="Menus" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: platInstance, field: 'menus', 'errors')}">
                                    <g:select name="menus" from="${cuisine.Menu.list()}" multiple="yes" optionKey="id" size="5" value="${platInstance?.menus*.id}" />
                                </td>
                            </tr>
