...
<html>
	<head>
		...
		<title><g:message code="Nouveau type de boisson" args="[entityName]" /></title>
	</head>
	<body>
		<a href="#create-typeBoisson" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-typeBoisson" class="content scaffold-create" role="main">
			<h1><g:message code="Créer nouveau type de boisson" args="[entityName]" /></h1>
